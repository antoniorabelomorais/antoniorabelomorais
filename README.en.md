...
[![en](https://upload.wikimedia.org/wikipedia/commons/a/a4/Flag_of_the_United_States.svg)](https://github.com/antoniorabelomorais/README.en.md)
...
- ?뵯 I?셫 currently working on ...
- ?뙮 I?셫 currently learning ...
- ?뫍 I?셫 looking to collaborate on ...
- ?쨺 I?셫 looking for help with ...
- ?뮠 Ask me about ...
- ?벇 How to reach me: ...
- ?쁽 Pronouns: ...
- ?? Fun fact: ...
...
# ?몝 Hi there, I'm Antonio Rabelo Morais (a.k.a. jarm)

[?눣?눡?눊?눇 English](#-about-me) | [?눉?눟 Brasileiro](#-sobre-mim)
...
---
## ?눣?눡?눊?눇 About me
- ?럳 Technical degree in **Administration** from **ETEC Dona Escol찼stica Rosa** (Santos, Brazil).  
- ?뱴 Current student at **SENAI Santos**, focusing on software development and systems.  
- ?룶 Entire primary and secondary education completed in Brazilian public schools.  
- ?뵮 Academic Curriculum (Brazilian Lattes system): [CNPq 5163563743904644](http://lattes.cnpq.br/5163563743904644)  
- ?뙋 Domain: [jarm.com.br](http://jarm.com.br)  
- ?됵툘 Mail: antoniorm@jarm.com.br  
...
?눣?눡?눊?눇 This profile is my **open lab**:  
- Not everything is polished...
- Some repositories are ready-to-use tools, others are just experiments.  
- The mess is intentional: it?셲 the record of a constant learning journey.  

---

## ?눉?눟 Sobre mim
- ?럳 Formado T챕cnico em **Administra챌찾o** pela **ETEC Dona Escol찼stica Rosa** (Santos/SP).  
- ?뱴 Estudante no **SENAI Santos**, focado em desenvolvimento de software e sistemas.  
- ?룶 Ensino Fundamental e M챕dio realizados integralmente em escolas p첬blicas do Brasil.  
- ?뵮 Curr챠culo Lattes: [CNPq 5163563743904644](http://lattes.cnpq.br/5163563743904644)  
- ?뙋 Dominio: [jarm.com.br](http://jarm.com.br)  
- ?됵툘 Endere챌o Eletr척nico: antoniorm@jarm.com.br  

### ??
- **Android & M처dulos Magisk** ?? explora챌찾o de baixo n챠vel do sistema.  
- **Experimentos em Linux** ?? scripts, tunings e testes de sistema.  
- **Projetos educacionais** ?? reposit처rios que documentam minha jornada de aprendizado.  
- **Explora챌찾o criativa** ?? utilit찼rios pequenos, prot처tipos e experimentos.  

## ?㎛

?눉?눟 Este perfil 챕 meu **laborat처rio aberto**:  
- Nem tudo 챕 polido...
- Alguns reposit처rios s찾o utilit찼rios prontos, outros apenas experimentos.  
- A bagun챌a 챕 proposital: registro de um caminho de aprendizado constante.  

---

## ?뱛

### ?뵩 Android & Linux Experiments
...
狩? Hope you find something useful here.
...
electron-for-code-oss/x11,now 37.3.1 aarch64 [installed,automatic]
...
libandroid-shmem/stable,now 0.5-1 aarch64 [installed,automatic]
...
libicu/stable,now 77.1-2 aarch64 [installed,automatic]
...
libunbound/stable,now 1.24.0 aarch64 [installed]
...
make/stable,now 4.4.1-1 aarch64 [installed,automatic]
...
xxhash/stable,now 0.8.3-1 aarch64 [installed]
